...
if 4 != len(sys.argv):
    print "Usage: python fireCRF.py lr dc L2 L1 "
    print ""
    print "Ex.: python fireCRF.py 0.1 0 0 0"
    sys.exit()
...
print 'best iteration selected! reporting results shortly... \n'

print 'Testing best model on trainset \n'
outputs_tr,costs_tr = best_model.test(trainset)

print 'Testing best model on validset \n'
